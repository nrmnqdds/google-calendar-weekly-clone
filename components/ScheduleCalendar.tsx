      ...
      <div className="overflow-auto w-full flex flex-col mb-2" id="schedule">
        <div className="flex flex-col flex-1">
          <div className="sticky top-0 flex bg-white z-20">
            ...
            {days.map((day, index) => (
              <div
                className="flex-1 min-w-[81px] flex flex-col text-black bg-white z-20 pt-4"
                key={day.date}
              >
          ...
          <div className="flex flex-1">
            <div className="bg-white sticky left-0 top-0 w-20 min-w-[70px] z-10">
              {hours24.map((hour) => (
                <div
                  className="font-light text-[12px] h-[60px] text-right pr-2 text-black"
                  key={hour.text}
                >
                  {hour.text}
                </div>
